...
public class CategoryCreateController implements SecureController<CategoryRequest, CategoryResponse> {
    ...
    public CategoryResponse handle(CategoryRequest request, Long userId) {
        ...
        CategoryDTO categoryDTO = categoryService.create(request.getName());
